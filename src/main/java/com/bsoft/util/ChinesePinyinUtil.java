...
public class ChinesePinyinUtil {
	...
	public static void main(String[] args) {
		String cnStr = "创业软件成都分公司";
		System.out.println("全拼音：" + getPingYin(cnStr));
		System.out.println("首字母拼音：" + getPinYinHeadChar(cnStr));
		System.out.println(getCnASCII("创业软件成都分公司"));
	}
}